...
const (
	ReportService_SubmitReport_FullMethodName = "/grpc.v1.ReportService/SubmitReport"
)
...
type ReportServiceClient interface {
	SubmitReport(ctx context.Context, in *ReportRequest, opts ...grpc.CallOption) (*ReportResponse, error)
}
...
func (c *reportServiceClient) SubmitReport(ctx context.Context, in *ReportRequest, opts ...grpc.CallOption) (*ReportResponse, error) {
...
type ReportServiceServer interface {
	SubmitReport(context.Context, *ReportRequest) (*ReportResponse, error)
...
func (UnimplementedReportServiceServer) SubmitReport(context.Context, *ReportRequest) (*ReportResponse, error) {
...
func _ReportService_SubmitReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReportServiceServer).SubmitReport(ctx, req.(*ReportRequest))
	}
...
var ReportService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc.v1.ReportService",
	...
	Metadata: "api/proto/v1/report.proto",
}
